...
import { 
  Zap, Shield, Globe, PlayCircle, Smartphone, 
  Mail, BarChart3, Cloud, MessageCircle, MapPin, ShoppingCart, Wifi 
} from "lucide-react";
...
const Display = () => {
  // Orbiting icons data
  const orbitingIcons = [
    { Icon: Mail, color: "text-blue-500", bg: "bg-blue-100", delay: 0, x: -140, y: -100 },
    { Icon: Wifi, color: "text-red-500", bg: "bg-red-100", delay: 1, x: 140, y: -100 },
    { Icon: BarChart3, color: "text-green-500", bg: "bg-green-100", delay: 2, x: 0, y: -160 },
    { Icon: MessageCircle, color: "text-yellow-500", bg: "bg-yellow-100", delay: 3, x: -140, y: 100 },
    { Icon: Cloud, color: "text-purple-500", bg: "bg-purple-100", delay: 4, x: 140, y: 100 },
    { Icon: ShoppingCart, color: "text-orange-500", bg: "bg-orange-100", delay: 5, x: 0, y: 160 },
  ];

  return (
    <div className="relative min-h-screen flex items-center bg-base-100 overflow-hidden pt-20 pb-20">
      {/* Background Decor */}
      ...
      <div className="max-w-[1250px] mx-auto px-6 w-full grid lg:grid-cols-2 gap-16 items-center z-10">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            Experience the ultimate ecosystem where all your tools, communication, 
            and data converge. Simplify your life with our all-in-one platform.
          </motion.p>
        ...
        >
          {/* Orbit Rings */}
          <div className="absolute border border-dashed border-base-content/10 rounded-full w-[300px] h-[300px] animate-spin-slow" style={{ animationDuration: '30s' }} />
          <div className="absolute border border-dashed border-base-content/10 rounded-full w-[450px] h-[450px] animate-spin-reverse-slow" style={{ animationDuration: '40s' }} />

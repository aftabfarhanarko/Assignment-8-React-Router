...
const Display = () => {
  ...
  return (
    <div className="">
      ...
      <div ref={ref} className="bg-gradient-to-tr from-[#632EE3] to-[#9F62F2] w-full text-white px-1 md:px-0">
        <div className="max-w-[1250px] mx-auto text-center py-20">
          ...
          <div  className="flex justify-around mt-10">
            <div>
              ...
              <h1 className="text-2xl md:text-5xl font-bold mt-3">
                {inView ? (
                  <CountUp end={29.6} duration={3} decimals={1} suffix="M" />
                ) : (
                  <span>29.6</span>
                )}
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-5xl font-bold mt-3">
                 {inView ? (
                  <CountUp end={ 998} duration={3} decimals={1} suffix="K" />
                ) : (
                  <span> 998</span>
                )}
               </h1>
            ...
            <div>
              ...
              <h1 className="text-2xl md:text-5xl font-bold mt-3">
                {inView ? (
                  <CountUp end={ 345} duration={3} decimals={1} suffix="+" />
                ) : (
                  <span>345</span>
                )}
                </h1>

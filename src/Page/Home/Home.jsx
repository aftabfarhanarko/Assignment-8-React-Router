...
const Home = () => {
  return (
    <div>
      ...
      <div className="bg-gradient-to-tr from-[#632EE3] to-[#9F62F2] w-full">
        <div className="max-w-[1250px] mx-auto text-center py-20">
          ...
          <div className="flex justify-around mt-10">
            <div>
              ...
              <h1 className="text-5xl font-bold mt-3">29.6M</h1>
              <p className="text-[13px] mt-3">21% more than last month</p>
            </div>
            <div>
              <p className="text-[13px]">Total Reviews</p>
              <h1 className="text-5xl font-bold mt-3">998K</h1>
              <p className="text-[13px] mt-3">46% more than last month</p>
            </div>
            <div>
              <p className="text-[13px]">Active Apps</p>
              <h1 className="text-5xl font-bold mt-3">345+</h1>
              <p className="text-[13px] mt-3">31 more will Launch</p>
            </div>
          </div>
        </div>
      </div>
